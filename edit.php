...
<?php
    ...
    $sql_mg = "SELECT * FROM xegiamgia";
    $query_mg = mysqli_query($conn, $sql_mg);
    $sql_up = "SELECT * FROM xegiamgia where ID = $id";
    ...
    $sql = "UPDATE xegiamgia SET tenxe = '$tenxe', giathue = '$giathue', tinhtrang = '$tinhtrang', anh = '$image' WHERE id = $id ";
