...
<?php
    ...
    $sql_mg = "SELECT * FROM xetulai";
    $query_mg = mysqli_query($conn, $sql_mg);
    $sql_up = "SELECT * FROM xetulai where ID = $id";
    ...
    $sql = "UPDATE xetulai SET tenxe = '$tenxe', giathue = '$giathue', tinhtrang = '$tinhtrang', anh = '$image' WHERE id = $id ";
