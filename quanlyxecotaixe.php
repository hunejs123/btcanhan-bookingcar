...
<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO xecotaixe (anh, tenxe, giathue, tinhtrang)
...
<?php
    $sql = "SELECT * FROM xecotaixe ORDER BY ID DESC";
    $query = mysqli_query($conn, $sql);
?>
<div class="content">
    <div class="card">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($query)){ ?>
                        <tr>
                            ...
                            <td> <a href="edit3.php?page_layout=edit&id=<?php echo $row['id']; ?>">Sửa</a> </td>
                            <td> <a onclick="return Del()" href="delete3.php?page_layout=delete&id=<?php echo $row['id']; ?>">Xóa</td>
                        </tr>
                    <?php }
                    ?> 
                </tbody>
